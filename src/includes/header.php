...
<head>
    ...
    <title>Panel de Administración | <?php echo $resulta['nombre']; ?></title>
    <link rel="shortcut icon" href="../assets/img/pastillas.png" />
...
<body>
    <div class="wrapper ">
        <div class="sidebar" data-color="purple" data-background-color="black" data-image="">
            <div class="logo btn btn-info "><a href="./" class="simple-text logo-normal">
            <!-- <i class="fas fa-hospital"></i>  <?php echo $resulta['nombre']; ?> -->
            <img src="../assets/img/logo_farma.png" class="img-fluid" style="width: 150px; height: 40px;" alt="">
                </a></div>
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#nuevo_pass">Cambiar clave</a>
