...
<head>
    ...
    <title>Iniciar Sesión | <?php echo $resulta['nombre']; ?></title>
    <!-- plugins:css -->
        ...
        <?php echo (isset($alert)) ? $alert : '' ; ?>
							<div class="card">
								<div class="card-header card-header-info text-center">
									<h4 class="card-title">Iniciar Sesión <?php  ?></h4>
									<img class="img-thumbnail" src="assets/img/logo_farma.png" width="200"/>
								</div>
								<div class="card-body">
									<?php echo isset($alert) ? $alert : ''; ?>
									<form action="" method="post" class="p-3">
										...
										<div class="mt-3">
											<button class="btn btn-block btn-success btn-lg font-weight-medium auth-form-btn" type="submit">Inicia Sesion</button>
										</div>
